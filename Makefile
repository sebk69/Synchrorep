lib_config = -fPIC -D_REENTRANT `pkg-config --cflags --libs gtk+-2.0 gdk-x11-2.0`
...
synchrorep: db_access.o ac_common.o ac_behavior.o ac_config.o ac_preferences.o tc_file_with_infos.o tc_files_binomial.o tc_find_files.o tc_misc.o dialog_info.o dialog_delete.o dialog_error.o dialog_file_conflict.o widget_behavior.o window_card.o window_config_main.o window_default_behavior.o new_synchronization.o execute.o logging.o application.o md5sum.o ac_logs.o widget_synchronization_log.o window_log.o window_ask_at_the_end.o widget_ask_at_the_end.o dialog_choose_mode.o tc_mount.o
	g++ -fPIC -L/usr/lib -o synchrorep db_access.o ac_common.o ac_behavior.o ac_config.o ac_preferences.o tc_file_with_infos.o tc_files_binomial.o tc_find_files.o tc_misc.o dialog_info.o dialog_delete.o dialog_error.o dialog_file_conflict.o widget_behavior.o window_card.o window_config_main.o window_default_behavior.o new_synchronization.o execute.o logging.o application.o md5sum.o ac_logs.o widget_synchronization_log.o window_log.o window_ask_at_the_end.o widget_ask_at_the_end.o dialog_choose_mode.o tc_mount.o -lgthread-2.0 -lsqlite3 -lgtk-x11-2.0 -lgio-2.0 `pkg-config --cflags --libs gtk+-2.0 gdk-x11-2.0`
...
package:
	...
	test -d synchrorep-package/usr/lib/nautilus/extensions-3.0 || mkdir synchrorep-package/usr/lib/nautilus/extensions-3.0
	...
	cp control synchrorep-package/DEBIAN/control	
